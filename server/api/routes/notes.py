...
def get_notes():
    ...
    jobObject = request.args.get('jobObject', default="", type=str)  # Default limit is 10 if not provided
    return notes_controller.get_notes(preferences, impairments, jobObject)
